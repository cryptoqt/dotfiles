...
beautiful.init("/usr/share/awesome/themes/bluish/theme.lua")
...
batimg:set_image("/home/bob/.config/awesome/battery.png")
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "n",
        function (c)
            ...
            -- minimizzed, since minimized clients can't have the focus.
            c.minimized = true
        end),
    awful.key({ modkey,           }, "m",
        function (c)
...
awful.rules.rules = {
    ...
    { rule = { class = "vmplayer" }, properties = { tag = tags[1][4] } },
}
-- }}}
